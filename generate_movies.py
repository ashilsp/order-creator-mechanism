...
from src.visualization import render_movie_s1, render_movie_s2, render_movie_s3

def main():
    print("🚀 Initializing Order Creator Mechanism Simulation Suite...")
    
    print("\n🎬 Processing: Movie S1 (Paradigm Shift Evolution)...")
    render_movie_s1("movie_s1_introduction.mp4")
    print("✅ Movie S1 successfully compiled.")
    ...
    print("\n🎉 Complete. All supplementary simulation files for Sections 1 & 2 are ready.")
